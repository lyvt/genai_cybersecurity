...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, hidden, encoder_hidden, mask_decoder, mask_encoder, self_position_bias=None,
        ...
        if self.layernorm_positioning == "post":
            ...
            mid = self.dropout_2(
                self.context_attn(encoder_hidden, encoder_hidden, query_norm, mask_encoder, context_position_bias))
            ...
            query = self.dropout_1(
                self.self_attn(hidden_norm, hidden_norm, hidden_norm, mask_decoder, self_position_bias))
            query = query + hidden
